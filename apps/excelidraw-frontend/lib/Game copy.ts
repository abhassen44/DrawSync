...
export class Game {
  ...
  // addAIShape(svgPath: string, position: { x: number; y: number }) {
  //   const svgElement = new Image();
  //   svgElement.src = `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="300" height="300"><path d="${svgPath}" fill="black" /></svg>`;

  //   svgElement.onload = () => {
  //     this.ctx.drawImage(svgElement, position.x, position.y, 100, 100); // Adjust size as needed
  //   };
  // }
